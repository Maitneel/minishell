...
CC := cc
CFLAG = -Wall -Wextra -Werror -I$(shell brew --prefix readline)/include -I${INCLUDE_DIR} -I${LIBFT_DIR} ${shell echo > ~/.inputrc set echo-control-characters off} -fsanitize=address -g 
